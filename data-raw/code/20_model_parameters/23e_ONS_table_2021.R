...
temp <- tempfile()
url <- "https://www.ons.gov.uk/file?uri=/economy/nationalaccounts/supplyandusetables/datasets/ukinputoutputanalyticaltablesdetailed/2021/iot2021product.xlsx"
temp <- curl_download(url=url, destfile=temp, quiet=FALSE, mode="wb")
...
inputoutput_2021 <- list(product_categories_io = product_categories_io,
